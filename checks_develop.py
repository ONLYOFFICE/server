...
class CDependencies:
  ...
  def append(self, oCdependencies):
    self.progsToInstall.union(oCdependencies.progsToInstall)
    self.progsToUninstall.union(oCdependencies.progsToUninstall)
    self.pathsToRemove.union(oCdependencies.pathsToRemove)
