...
const editorDataStorageModule = await import(`./${cfgEditorDataStorage}.js`);
const editorDataStorage = editorDataStorageModule;

const editorStatStorageModule = await import(
  `./${cfgEditorStatStorage || cfgEditorDataStorage}.js`
);
const editorStatStorage = editorStatStorageModule;
...
export const editorData = editorDataStorage.EditorData ? new editorDataStorage.EditorData() : new editorDataStorage();
export const editorStat = editorStatStorage.EditorStat ? new editorStatStorage.EditorStat() : new editorDataStorage();
