...
(function (exports, undefined) {
  ...
  AI.isLocalDesktop = (function () {
    if (
      window.navigator &&
      window.navigator.userAgent.toLowerCase().indexOf("ascdesktopeditor") < 0
    )
      return false;
  ...
  AI.isLocalDesktopForNotStreamedRequests = (function () {
    if (AI.isLocalDesktop) return true;

    if (window.location && window.location.protocol == "onlyoffice:") return true;
