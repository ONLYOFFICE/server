...
showLoader = function (parent, text) {
  var themeType =
    window.Asc && window.Asc.plugin && window.Asc.plugin.theme && window.Asc.plugin.theme.type;
  var loader = document.createElement("div");
  loader.className = "asc-plugin-loader";
  loader.innerHTML =
    '<div class="asc-loader-image asc-loader-image-' +
    (themeType === "dark" ? "light" : "dark") +
    '"></div><div class="asc-loader-title">' +
    (text || "Loading") +
    "</div>";
...
!(function (e) {
  function n(n) {
    ...
    var e = "(?:" + Object.keys(n).join("|") + ")",
      ...
      c = RegExp(e, "g");
    return function (e) {
      return ((e = null == e ? "" : "" + e), u.test(e) ? e.replace(c, t) : e);
    };
  }
  ((escape = n({
    "&": "&amp;",
...
var select2_amd, select2_defaults;
"undefined" != typeof jQuery &&
  null != $.fn.select2 &&
  ((select2_amd = $.fn.select2.amd),
  (select2_defaults = $.fn.select2.defaults),
  $.fn.select2.amd.define(
    ...
    function (e, t, n, l) {
      var s = e.Decorate(t, l);
      (s = e.Decorate(s, n)).prototype.render = function () {
        var e = l.prototype.render.call(this, t.prototype.render);
        return (
    ...
    function (s, e, c, t, o) {
      ...
      return (
        null != s.fn.select2 &&
          ...
          (s.fn.select2 = function (l) {
            if (
              (((l = l || {}).selectionAdapter =
                !1 !== l.selectionAdapter
                  ? select2_amd.require("SearchableSingleSelection")
                  : void 0),
              (l.dropdownAdapter =
                !1 !== l.dropdownAdapter ? select2_amd.require("UnsearchableDropdown") : void 0),
              "object" == typeof l)
            )
              return (
                this.each(function () {
                  var e = s.extend(!0, {}, l),
                    t = new c(s(this), e),
                    n = s(this).next().find(".select2-search.select2-search--dropdown"),
                    e = s(this)
                      .next()
                      .find("span.selection")
            ...
            if ("string" != typeof l) throw new Error("Invalid arguments for Select2: " + l);
            var t,
  ...
  $.fn.select2.amd.require("jquery.select2_"),
  ($.fn.select2.amd = select2_amd),
  ($.fn.select2.defaults = select2_defaults));
